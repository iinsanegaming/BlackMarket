...
function LocateGuy()
    exports['qbr-target']:AddBoxZone("locateguy", vector3(-1054.96, -243.53, 44.02), 1.0, 1.0, {
        name="locateguy",
        heading=30,
        --debugPoly=true,
        minZ=43.82,
    ...
    while true do
        ...
        if hours >= Config.Open or hours < Config.Close then
                ...
                if not DoesEntityExist(marketguy) then
                    ...
                    exports['qbr-target']:AddTargetEntity(marketguy, {
                        options = {
                            { 
...
AddEventHandler('onResourceStop', function(resourceName) 
	if GetCurrentResourceName() == resourceName then
        DeleteMarketGuy()
        exports['qbr-target']:RemoveZone("locateguy")
	end 
end)
